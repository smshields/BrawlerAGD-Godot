...
public class GenomeDiversityTests
{
    ...
    public void DistanceIsHandComputable()
    {
        ...
        // Dimensions: 2 chars × (20 char params [12 + the 2026-07-13 appends +
        // dropThroughDelay 2026-09-01] + 12 move params) = 64. Expected: 0.5 / 64.
        GameGenome a = Arena();
        ...
        Assert.Equal(0.5 / 64.0, distance, 6);
    }
