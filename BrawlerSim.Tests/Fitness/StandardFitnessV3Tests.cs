...
public class StandardFitnessV3Tests
{
    ...
    public void RegistryCreatesEveryVersionAndRejectsUnknown()
    {
        ...
        // Auto default (2026-09-14, self-hit reward fix): v7 for two-player runs,
        // ffa-v3 for 3/4 (SelfBlindFitnessTests pins the full default surface).
        Assert.Equal("standard-v7", FitnessRegistry.Create(null, 45f, 60f).Name);
        Assert.Equal("ffa-v3", FitnessRegistry.Create(null, 45f, 60f, playerCount: 4).Name);
