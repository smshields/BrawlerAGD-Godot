...
public partial class GameBuilderView : Control
{
    ...
    /// <summary>Minimap-style stage layout preview: kill box, platforms, spawn dots.</summary>
    private sealed partial class StageThumb : Control
    {
        private readonly StageGenome _stage;
