...
/// changes what fitness measures (DEVIATIONS.md) and moves the agent goldens.
/// </summary>
internal static class AgentGeometry
{
    ...
    /// map size (2026-07-21, DEVIATIONS #27) — exactly the legacy box on legacy maps.</summary>
